...
const actualSphereRadius = computed(() => {
  if (props.sphereRadius)
    return props.sphereRadius;
...
function generateSpherePositions(): SphericalPosition[] {
...
function calculateWorldPositions(): WorldPosition[] {
...
function clampRotationSpeed(speed: number): number {
